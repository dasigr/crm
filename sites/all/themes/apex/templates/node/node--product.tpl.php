    ...
    <div<?php print $content_attributes; ?>>
    	<div style="display: table; width: 100%; clear: both;">
          ...
          <?php print render($content['field_product_rating']); ?>
      		...
      		<?php print render($content['field_manufacturer']); ?>
      		<?php print render($content['product:commerce_stock']); ?>
      		<?php print render($content['product:commerce_price']); ?>
      		<?php print render($content['field_product_variations']); ?>
      		<?php print render($content['flag_compare']); ?>

        	<div class="social-share" style="display: table; width: 100%; clear: both;">
        		<span><strong>Share:</strong> </span><?php print render($content['addtoany']); ?>
        	</div>
      	</div>
    	</div>
        ...
        hide($content['links']);
        hide($content['product:field_image']);
        hide($content['field_product_rating']);
    		hide($content['product:sku']);
    		hide($content['field_manufacturer']);
    		hide($content['product:commerce_stock']);
    		hide($content['product:commerce_price']);
    		hide($content['field_product_variations']);
    		hide($content['flag_compare']);
    		hide($content['field_product_specs']);
    	?>

			<?php if (isset($content['body'])): ?>
      <div class="product-detail" style="display: table; width: 100%; clear: both;">
      	<?php print render($content); ?>
      </div>
      <?php endif; ?>

			<?php if (isset($content['field_product_specs']['#items'])): ?>
      <div class="product-specs" style="display: table; width: 100%; clear: both;">
      	<?php print render($content['field_product_specs']); ?>
      </div>
      <?php endif; ?>
    </div>
