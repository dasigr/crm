 ...
 */
function apex_breadcrumb($variables) {
  $breadcrumb = $variables['breadcrumb'];
  $output = '';

  // Determine if we are to display the breadcrumb.
  $show_breadcrumb = theme_get_setting('apex_breadcrumb');
  if ($show_breadcrumb == 'yes' || $show_breadcrumb == 'admin' && arg(0) == 'admin') {

    // Optionally get rid of the homepage link.
    $show_breadcrumb_home = theme_get_setting('apex_breadcrumb_home');
    ...
    if (!empty($breadcrumb)) {
      $breadcrumb_separator = filter_xss_admin(theme_get_setting('apex_breadcrumb_separator'));
      $trailing_separator = $title = '';
      if (theme_get_setting('apex_breadcrumb_title')) {
        $item = menu_get_item();
      ...
      elseif (theme_get_setting('apex_breadcrumb_trailing')) {
 ...
 */
function apex_commerce_wishlist_product_add_link($variables) {
  $user = $variables['user'];
  ...
  return l('<i class="fa fa-heart"></i>', $url, $params);
}
...
function apex_preprocess_block(&$variables) {
  if ($variables['block_html_id'] == 'block-views-slideshow-block') {
